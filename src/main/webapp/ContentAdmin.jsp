...
<body>
	...
	<div class="card">
		...
		<div class="card-body">
			<h5 class="card-title">Template for Sports blog</h5>
			<p class="card-text">With supporting text below as a natural
				lead-in to additional content.</p>
			<!-- <a href="template.jsp?template=template2.xml" class="btn btn-primary">Select</a> -->
			<form id="loginFormId" name="loginForm" method="post">

				<div id="loginBtn">
					<input id="btn" class="btn btn-primary" type="submit"
						value="Submit" onclick="callServlet();" />
				</div>
			</form>
		</div>
	</div>
