 ...
 */
public class ContenAdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (fileItemsIterator.hasNext()) {
				...
				File file = new File("E:\\New_Workspace\\DMProject\\src\\main\\webapp\\CSSArticle.html");
				fileItem.write(file);
			}
